...
def convert_field_to_string(field, registry=None):
    return String(description=field.db_name, required=field.required)


@convert_motorodm_field.register(motorodm.fields.ObjectIdField)
def convert_field_to_id(field, registry=None):
    return ID(description=field.db_name, required=field.required)
...
def convert_field_to_int(field, registry=None):
    return Int(description=field.db_name, required=field.required)


@convert_motorodm_field.register(motorodm.fields.BooleanField)
def convert_field_to_boolean(field, registry=None):
    return NonNull(Boolean, description=field.db_name)
...
def convert_field_to_float(field, registry=None):
    return Float(description=field.db_name, required=field.required)
...
def convert_field_to_list(field, registry=None):
    ...
    return List(base_type, description=field.db_name, required=field.required)
